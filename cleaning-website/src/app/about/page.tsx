...
export default function Gallery() {
  ...
  return (
    <div className="font-sans bg-white text-[#222]">
      ...
      <section className="w-full py-12 px-4 bg-white relative overflow-hidden min-h-[600px] flex items-center">
        ...
        <div className="relative z-10 max-w-4xl mx-auto w-full">
          <h2 className="text-4xl font-bold mb-10 text-center">How it started </h2>
          <p
            className="text-gray-800 leading-relaxed text-center mx-auto max-w-3xl"
            style={{ fontSize: "16px", lineHeight: "1.8" }}
          >
  ...
  <div className="max-w-6xl mx-auto relative z-20">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
      ...
      <div className="bg-white p-6 rounded-lg border border-blue-200 shadow-sm relative flex flex-col">
        <div className="flex items-center mb-4">
          ...
          <h3 className="text-xl font-semibold text-amber-500">Select a service</h3>
        </div>
      ...
      <div className="bg-white p-6 rounded-lg border border-blue-200 shadow-sm relative flex flex-col">
        <div className="flex items-center mb-4">
          <span className="text-amber-500 text-xl mr-2">📞</span>
          <h3 className="text-xl font-semibold text-amber-500">Make an appointment</h3>
        </div>
        <p className="text-gray-600 text-sm">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vulputate libero et velit interdum, ac
          aliquet odio mattis. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vulputate libero.
      ...
      <div className="bg-white p-6 rounded-lg border border-blue-200 shadow-sm relative flex flex-col">
        <div className="flex items-center mb-4">
          <span className="text-amber-500 text-xl mr-2">💳</span>
          <h3 className="text-xl font-semibold text-amber-500">Proceed with the payment</h3>
        </div>
        <p className="text-gray-600 text-sm">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vulputate libero et velit interdum, ac
          aliquet odio mattis. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vulputate libero.
    ...
    <div className="flex justify-center mb-6">
      <span className="text-amber-500 text-5xl">↩️</span>
    </div>

    {/* Card 4 - Final step */}
    <div className="max-w-md mx-auto bg-white p-6 rounded-lg border border-blue-200 shadow-sm flex items-center">
      {/* Mirrored thumbs up image on the left */}
      <div className="hidden md:block mr-4 flex-shrink-0">
        <Image src="/images/about/13.png" alt="Thumbs Up" width={120} height={120} className="object-contain" style={{transform: 'scaleX(-1)'}} />
      </div>
      <div>
        <div className="flex items-center mb-4">
          <span className="text-green-500 text-xl mr-2">✅</span>
          <h3 className="text-xl font-semibold text-green-500">Get your work done !</h3>
        </div>
        <p className="text-gray-600 text-sm">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vulputate libero et velit interdum, ac aliquet
